---
title: Tech-Pub - Sviluppare per Alexa utilizzando .NET Core
description: "XE Tech-Pub tenuto da Andrea Dottor: In questo XE Tech-Pub andremo in dettaglio sul come realizzare una skill di Alexa (l'assistente vocale di Amazon) sfruttando delle API sviluppate con ASP.NET Core (o realizzando delle Azure Function). [...]"
date: 2019-01-18
eventType: Tech-Pub
venue:
  name: Ice and Co.
